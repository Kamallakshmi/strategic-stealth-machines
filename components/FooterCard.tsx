  ...
  return (
    <footer className="relative text-navy py-10 bg-white z-20">
      <div className="container mx-auto grid lg:grid-cols-5 gap-10 px-7">
        <div className="lg:col-span-2 flex flex-col items-center lg:items-start space-y-2.5 relative p-5 border border-transparent rounded-lg bg-gradient-to-b from-navy via-indigo-900 to-gray-200 shadow-lg">
        ...
        <div className="lg:col-span-1 flex flex-col items-center lg:items-start space-y-5">
          ...
          <Link
            href="/contact"
            // href="mailto:info@strategicmachines.ai"
      ...
      <div className="border-t border-gray-700 mt-10 pt-5 text-center text-md">
        <p className="text-navy">
          © Strategic Machines 2024 | All Rights Reserved
        </p>
